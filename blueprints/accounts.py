...
LINE_REDIRECT_URI_LOGIN = "https://illust.gochiusa.team/line_callback"
LINE_REDIRECT_URI_CONNECT = "https://illust.gochiusa.team/line_connect"

NOTIFY_CHANNEL_ID = "Ydvs9LZnzXywlWqp9kjHYC"
NOTIFY_CHANNEL_SECRET = "LNVrsAtQXnLQJW2pjGWCUxaj1ye994ntrK8zoPbl5JD"
NOTIFY_ENDPOINT = "https://notify-bot.line.me/oauth/token"
NOTIFY_REDIRECT_URI_CONNECT = "https://illust.gochiusa.team/line_notify_connect"

TELEGRAM_BOT_TOKEN = "1213031262:AAEcfftAf1rd4Re0cn17Y_ZAkV9LQrFa8aE"
...
def createAccount():
    ...
    password = "enc_usagi_hash"+password
    ...
    toyApiResp = requests.post(
        ...
        json={"name": displayID, "password": "gochi_api_user_{displayID}"}
    )
...
def loginAccountWithForm():
    ...
    # ID/パスワードログイン
        ...
        password = "enc_usagi_hash"+params["password"]
        password = hashlib.sha256(password.encode("utf8")).hexdigest()
        apiKey = g.db.get(
...
def editAccount(accountID):
    ...
    for p in params.keys():
        ...
        if p == "userPermission" and g.userPermission < 9:
            continue
        if p == "userPassword":
            params["userOldPassword"] = "enc_usagi_hash"+params["userOldPassword"]
            ...
            params[p] = "enc_usagi_hash"+params[p]
